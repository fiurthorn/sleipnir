...
Sleipnir nutzt eine erweiterte Implementierung des ursprünglichen `jsonpath.js`
(Stefan Goessner), optimiert für moderne Runtimes (Deno, Bun, Node).
...
Sleipnir unterstützt den vollen JSONPath-Standard sowie funktionale
Erweiterungen:
...
Du kannst eigene Funktionen definieren, die innerhalb des Pfad-Ausdrucks zur
Verfügung stehen:
